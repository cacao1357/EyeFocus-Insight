...
> **版本**：v4.1 | **制定日期**：2026-05-28 | **修订日期**：2026-06-02
> **方法论**：gstack（YC Office Hours → CEO Review → Eng Review → Build → Ship）
>
> **团队规模**：3 人 | **工期**：约 27 天（含 insights Spike + 实施） | **目标平台**：Windows 笔记本 | **项目定位**：课程/作品集
...
```
Spike ─── Day 1-3 ────────── Day 4-12 ───── Day 13 ──── Day 14-20 ──────── Day 21-27
[预开发 2d]  [Phase 1 MVP 8d]  [Insights Spike 1d]  [Phase 2 报告+创新+离线分析 7d]  [Phase 3 交付打磨 7d]
   ▲              ▲                    ▲                     ▲                        ▲
   │              │                    │                     │                        │
技术去风险    M1: 核心引擎          Insights 原型          M2/M3: 完整会话           M5-M8: 项目交付
三人并行实测  可运行+实时显示       5 方法 PASS           HTML + 4 章节分析          打包+文档+PPT
```
...
#### Phase 2：Should Have（Day 14-20）

| 里程碑 | Day 范围 | 内容 |
|---------|----------|------|
| **M3a: 报告生成** | Day 14-15 | HTML reporter + Matplotlib 图表 |
| **M3b: 分心模式识别** | Day 15-16 | distraction.py → 热力图数据 → 报告嵌入 |
| **M3c【v4.1】: Insights 实施** | Day 16-18 | T220-T227 insights 子包完整实现 + 单元测试 |
| **M3d【v4.1】: 报告 4 章节集成** | Day 18 | T228 工作模式/异常/趋势/建议章节渲染 |
| **A4: 专注度算法真人测试** | Day 19 | 2-3 人测试数据收集，权重调优 |
| **M4: 集成测试 + Phase 2 验收** | Day 20 | T229+T230 性能 < 10s + 全覆盖 ≥ 75% |

#### Phase 3：交付与打磨（Day 21-27）

| 里程碑 | Day 范围 | 内容 |
|---------|----------|------|
| **M5: 边界测试 + 修复** | Day 21-22 | 眼镜降级、人脸丢失、低光照等边界问题 |
| **M6: 文档撰写** | Day 22-23 | ARCHITECTURE + API + README + USER_GUIDE |
| **M7: .exe 打包** | Day 23-24 | PyInstaller 打包 + 无 Python 环境测试 |
| **M8: 答辩 PPT** | Day 24-27 | 技术架构 + 核心算法 + 创新点 + 演示 |
...
### 15.4 Phase 2：Should Have（Day 14-20）
