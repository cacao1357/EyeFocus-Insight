...
> **版本**：v1.3 | **制定日期**：2026-05-30 | **最后更新**：2026-05-31
> **阶段目标**：MVP — 核心产品代码实现
...
| 任务ID | 描述 | 负责人 | 估时 | 依赖 | 状态 |
|--------|------|--------|------|------|------|
| T148a | analyzer/user_calibration.py 用户校准管理器 | D1 | 2h | T113 | 📋 设计完成 |
| T148b | storage/models.py 新增 CalibrationSignal 等数据模型 | D1 | 0.5h | T102 | 📋 设计完成 |
| T148c | storage/db.py 新增 calibration 表 | D1 | 0.5h | T148b | 📋 设计完成 |
| T148d | gui/overlay.py 新增校准 UI（倒计时/输入/对比）| D2 | 2h | T128 | 📋 设计完成 |
| T148e | main.py 集成用户校准流程 | D1 | 1h | T148a, T148d | 📋 设计完成 |
| T148f | 用户校准单元测试 | D2 | 0.5h | T148a | 📋 设计完成 |
...
> **下一步**：T100 配置系统 + T148 用户辅助校准 + T136-T142 单元测试
